...
\verb!Tcl_Obj! ou uma forma de registrador. % ou bytes com sinal.
...
XXX Contagem de referência e valores compartilhados ... XXX.
% XXX ... XXX
...
detalhes da semântica existente na primeira, ... XXX.

Máquinas virtuais baseadas em registradores são capazes de sintetizar
aquelas baseadas em pilha, mas não necessariamente utilizam menos
memória.
